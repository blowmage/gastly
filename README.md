...
Create screenshots or previews of web pages using Gastly. Under the hood [Phantom.js](https://github.com/ariya/phantomjs/) and [ruby-vips](https://github.com/libvips/ruby-vips).
